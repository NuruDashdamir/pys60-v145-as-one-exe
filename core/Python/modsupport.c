...
#else
#define _Py_PackageContext (PYTHON_GLOBALS->_Py_PackageContext)
#endif
...
// XXX:CW32
DL_EXPORT(PyObject*)
Py_InitModule4(char *name, const PyMethodDef *methods, const char *doc,
	       PyObject *passthrough, int module_api_version)
{
	...
	// XXX:CW32
	for (ml = (PyMethodDef *)methods; ml->ml_name != NULL; ml++) {
