...
{
	PyObject *x = NULL;
	static const char *const kwlist[] = {"object", 0};
...
#else
const PyTypeObject c_PyString_Type = {
...
#else
#define interned (pyglobals->interned)
#endif
...
#undef characters
#undef nullstring
#define characters ((PyStringObject**)(pyglobals->characters))
#define nullstring ((PyStringObject*)(pyglobals->nullstring))
#endif
...
#ifdef INTERN_STRINGS
DL_EXPORT(void)
_Py_ReleaseInternedStrings(void)
{
#ifdef SYMBIAN
        SPy_Python_globals* pyglobals = PYTHON_GLOBALS; // avoid TLS reads
#endif
